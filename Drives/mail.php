...
<body style="font-family: 'Marcellus-Regular';">
	<!-- banner -->
				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">Login<i>Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
	...
	<div class="mail">
		...
		<div class="container">
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3768.8509481266597!2d73.04095067491531!3d19.15800068206351!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7bf82d975880b%3A0xa28af202166f2da4!2sGovernment%20Polytechnic%20Thane!5e0!3m2!1sen!2sin!4v1682870357703!5m2!1sen!2sin" width="940" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
			</div>
			<div class="mail-grids">
				<div class="col-md-6 mail-grid-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					...
					<p>Diva 
						<span>Phadke Road, Phadkepada, Mumbra, Thane</span>
						India IN-400612
					</p>
					<h4>Get In Touch</h4>
					<p>Telephone: +91 99696 01972
						<span>FAX: +91 7000830947</span>
						E-mail: <a href="mailto:citcollege@rediffmail.com">gpt@gmail.com</a>
					</p>
				</div>
	...
	<!-- footer -->
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Address</h3>
					<div class="address">
						<p>Lokmanya Tilak College of Engineering
							<span>Diva, Thane</span>
						</p>
					</div>
					<div class="phone">
						<p>+917000830947</p>
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">Lokmanya Tilak College of Engineering</h6>
					<h4>
		...
		<div class="copyright">
			...
			<div class="container">
              ...
              <a href="http://gpt.org.IN" target="_parent">LTians</a>
				</div>
