...
// if($rs_result){
//   $row_count = mysqli_num_rows($rs_result); // Count the number of rows in the result set

//   if ($row_count > 1) {
//       echo "There are more than 1 rows in the table.";
//   } elseif ($row_count == 1) {
//       echo "There is exactly 1 row in the table.";
//   } else {
//       echo "There are no rows in the table.";
//   }

//   echo " Yes, there's data in the table.";
//   echo "yes there's data in table";
// }
// else{
//   echo 'there is no data in the table you dubm!';
// }
