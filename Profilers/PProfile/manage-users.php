...
$sql = "SELECT * FROM basicdetails where Id='1' ORDER BY Id DESC LIMIT $start_from, $num_rec_per_page"; 
...
$prev = $currentpage-1;
 ...
 ?> 
        ...
        <footer class="text-right">
            ...
            | Developed by <a href="https://gpthane.org.in/" target="_parent">LTians</a></p>
          </footer>         
        </div>
      </div>
    </div>
