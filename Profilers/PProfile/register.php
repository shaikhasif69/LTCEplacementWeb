...
$nameErr = $passErr = $emailerr = $branchErr = "";
$Name  = $password = $repassword = $Email = $Branch = "";
   ...
   $connect = mysql_connect("127.0.0.1", "root", ""); // Establishing Connection with Server
		...
		$check = mysql_query("SELECT * FROM slogin WHERE USN='".$USN."'") or die("Check Query");
 		if(mysql_num_rows($check) == 0) 
 		{
  			...
  			{
    			if($query = mysql_query("INSERT INTO hlogin(Username,Password,Email,Branch) VALUES ('$Name','$USN','$password','$Email',$Branch)"))
    			{
