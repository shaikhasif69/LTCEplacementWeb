	        ...
	        <form method="POST" class="templatemo-login-form" action="reg.php">
				...
				<div class="col-lg-6 col-md-6 form-group">
                  ...
                  <select class="form-control" name="Branch">
                    ...
                    <option value="BScience">CO</option>
	        		...
	        		<div class="input-group">
		        		<div class="input-group-addon"><i class="fa fa-user fa-fw"></i></div>	        		
		              	<select type="text" name="Question" class="form-control" placeholder="Security Question*" > 
								...
								<option value="What is your fav sport?">What is your fav sport?</option>
		          	...
		          	<option value="What is your first mobile number?">What is your first mobile number?</option>	
						<option value="What is your one truth which others do not know?">What is your one truth which others do not know?</option>
...
$nameErr = $usnErr = $passErr = $emailerr = $Qerr = $Anserr = $branchErr = "";
$Name = $USN = $password = $repassword = $Email = $Question = $Answer = $Branch =  "";
