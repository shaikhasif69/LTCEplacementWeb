            ...
            <form action="pref.php" class="templatemo-login-form" method="post" enctype="multipart/form-data">
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">
                  ...
                  <input type="text" name="Fname" class="form-control" id="inputFirstName" placeholder="Name">
                </div>
                <div class="col-lg-6 col-md-6 form-group">
				...
				<div class="col-lg-6 col-md-6 form-group">
                  ...
                  <input type="text" name="USN" class="form-control" id="usn" placeholder="2001160196" >
                </div>
